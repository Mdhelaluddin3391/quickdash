# Generated by Django 5.0.2 on 2025-12-21 19:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_rider', models.BooleanField(db_index=True, default=False)),
                ('is_employee', models.BooleanField(db_index=True, default=False)),
                ('app_role', models.CharField(blank=True, max_length=32, null=True)),
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='profile_pics/')),
                ('fcm_token', models.CharField(blank=True, max_length=255, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('is_staff', models.BooleanField(default=False)),
                ('date_joined', models.DateTimeField(default=django.utils.timezone.now)),
                ('current_session_jti', models.CharField(blank=True, help_text='Tracks the JWT ID of the currently active session', max_length=255, null=True)),
